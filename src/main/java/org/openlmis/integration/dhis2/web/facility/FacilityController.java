...
package org.openlmis.integration.dhis2.web.facility;
...
public class FacilityController extends BaseController {
  ...
  public static final String RESOURCE_PATH = API_PATH + "/facilities/refresh";
  ...
  /**
   * Manually refresh shared facility list.
   */
  @PostMapping
  @ResponseStatus(HttpStatus.OK)
  public void runRefreshList() {
    permissionService.canManageDhisIntegration();
    LOGGER.debug("Refreshing shared facility list");
